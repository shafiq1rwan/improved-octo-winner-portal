...
IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = @db_name)
	BEGIN	
		...
		BEGIN
			...
			INSERT general_configuration ([description], [parameter], [value]) VALUES (''BYOD Setting - Main Logo Image'', ''mainLogoPath'', ''http://localhost:8080/assets/images/byodadmin/default/default_main_logo.png'')
			INSERT general_configuration ([description], [parameter], [value]) VALUES (''BYOD Setting - Shortcut Logo Image'', ''shortcutLogoPath'', ''http://localhost:8080/assets/images/byodadmin/default/default_shortcut_logo.png'')
			INSERT general_configuration ([description], [parameter], [value]) VALUES (''BYOD Setting - Main Background Image'', ''mainBackgroundPath'', ''http://localhost:8080/assets/images/byodadmin/default/default_background.png'')
			INSERT general_configuration ([description], [parameter], [value]) VALUES (''BYOD Setting - Landing Logo Image'', ''landingLogoPath'', ''http://localhost:8080/assets/images/byodadmin/default/default_landing_logo.png'')
