...
<style>
body {
	background-image: url(${pageContext.request.contextPath}${applicationData.getMainBackgroundPath()});
...
.sub-text-color {
	color: ${applicationData.getSubTextColor()} !important;
}
button.btn-locale {
...
span.back-icon {
    ...
    background: no-repeat center center;
    background-size: 100% 100%;
	background-image: url("data:image/svg+xml;charset=utf8,%3Csvg viewBox='0 0 199.404 199.404' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath stroke='${applicationData.getSubColor()}' fill='${applicationData.getSubColor()}' stroke-width='2' stroke-linecap='round' d='M135.412,0 35.709,99.702 135.412,199.404 163.695,171.119 92.277,99.702 163.695,28.285z'/%3E%3C/svg%3E") !important;
}
span.cart-icon {
	display: inline-block;
    width: 2.0em;
