<body>
	<div id="edit-tier-selection-overlay" class="page-overlay"
		ng-click="hideFromView('editTierSelection')">
				...
				<div
					...
					<div class="d-flex flex-column pt-1 pb-1">
						<button
							...
							type="button" ng-click="hideFromView('editTierSelection')">{{currentLanguageData.tier_selection_done}}</button>
					</div>
				</div>
			</div>
		</div>
