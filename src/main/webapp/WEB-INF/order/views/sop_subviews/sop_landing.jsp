	...
	<div id="landing-overlay" class="page-overlay main-bg">
		<div
			...
			<div class="dropdown align-self-center ml-2">
				<button class="btn btn-secondary btn-locale md-resp-font"
					style="border-width: 2px; line-height: 1; padding: 4px;"
				...
				<div class="dropdown-menu" aria-labelledby="languageDropDown">
					<a
						...
						ng-repeat-start="localeObj in localeData"
						ng-if="localeObj == currentLocale"
						...
						ng-repeat-end="localeObj in localeData"
						ng-if="localeObj != currentLocale"
						ng-click="changeLocale(localeObj)">{{localeObj.name}}
			...
			<div class="align-self-center mr-1">
				<button type="button" ng-click="getCheckData()"
		...
		<div class="body-content">
			<div id="landing-main-content"
				...
				<div
					...
					<span class="align-self-center xs-resp-font"><i
						class="fas fa-store-alt"></i>&nbsp;{{currentLanguageData.landing_storeName}}</span>
				</div>
			...
			<div id="landing-footer-content"
				...
				<span class="align-self-center resp-font">Powered By&nbsp;<img
					class="font-size-img"
