...
<body class="adminbody">
	<div id="main">
							...
							<div class="card mb-3">
								<div class="card-header d-flex flex-row justify-content-between">
									...
									<button type="button"
										...
										data-toggle="modal" data-target="#createItemGroupModal" data-backdrop="static" data-keyboard="false"
		...
		<div class="modal fade" id="createItemGroupModal" role="dialog"
			aria-labelledby="createItemGroupModal" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form id="itemGroupForm" method="POST" accept-charset="UTF-8" role="form" class="form-signin">
						<div class="modal-header">
							<h5 class="modal-title">Item Group Detail</h5>
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">			
										<div class="form-row">
											<div class="form-group col-md-8">
												...
												<input class="form-control" name="modifierGroupName" placeholder="Name" type="text" ng-model="menu_item_group.menu_item_group_name" required>
											</div>																	
										</div>
										<div class="form-row">
											<div class="form-group col-md-8">
												<div class="custom-control custom-checkbox">
													<input type="checkbox" name="modifierGroupActiveStatus" ng-model="menu_item_group.is_active" class="custom-control-input" id="customCheck1">
